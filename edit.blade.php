...
@endif
  ...
  <div class="form-group">
    ...
    <input type="text"   class="form-control" name="address" value=" {{ $data->address}}" id="exampleInputPassword1" placeholder="Address">
  </div> 
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="url"   class="form-control" name="linkedIn" value="{{ $data->linkedIn }}" id="exampleInputPassword1" placeholder="LinkedIn Url">
  </div>


  <div class="form-group">
    <label for="exampleInputPassword">Image</label>
    <input type="file"   class="form-control" name="image" value="{{ $data->image}}" id="exampleInputPassword1">
  </div>
